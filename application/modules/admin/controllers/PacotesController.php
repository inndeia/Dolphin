<?php
class Admin_PacotesController extends Zend_Controller_Action
{
	...
	public function init()
	{
        ...
        $this->view->title = $this->title = 'Pacotes';
	...
	public function indexAction()
	{
		...
		$this->view->breadcrumb = array($this->title => 'admin/pacotes');
...
// 						$this->_redirect('/admin/pacotes/addpacote');
// 					}
// 				}
// 			}else{
// 				$image = '';
...
// 					} else {
// 						$this->_helper->FlashMessenger('Erro ao carregar imagem!');
// 						$this->_redirect('/admin/pacotes/editarpacote/id/'.$rs['id']);
// 					}
// 				}
// 			}
			if($imageBanner['name'] != ''){
...
// 			}
	...
	public function editarConteudoAction(){
		...
		$id = $this->getRequest()->getParam('id');
		$this->view->breadcrumb = array($this->title => 'admin/pacotes/editar-conteudo/id/1');
		...
		if (is_null($rs)) {
			$this->_helper->FlashMessenger('Operação não permitida!');
			$this->_redirect('/admin/pacotes/editar-conteudo/id/1');
		}
